...
namespace JPK_WysylkaXML.EditXML.ViewModels.JPK_V7M.v2_1E
{
    public class JpkV7MEditSaleDetailsViewModel : ViewModelBase
    {
        ...
        public List<ItemChoiceType1> ItemChoiceOptions { get; } = new() {ItemChoiceType1.DataZaplaty, ItemChoiceType1.TerminPlatnosci};
        ...
        {
            get => _saleEntry.WSTO_EE;
            set
            {
                _saleEntry.WSTO_EE = value;
                _saleEntry.WSTO_EESpecified = value == 1;
            }
        }
        ...
        public sbyte IED
        {
            ...
            set
            {
                _saleEntry.IED = value;
                _saleEntry.IEDSpecified = value == 1;
            }
        }
        ...
        {
            get => _saleEntry.ItemElementName;
            set => _saleEntry.ItemElementName = value;
        }

        public DateTime Item
        {
            get => _saleEntry.Item;
            set => _saleEntry.Item = value;
        }

        public sbyte KorektaPodstawyOpodt
        {
            get => _saleEntry.KorektaPodstawyOpodt;
            set
            {
                _saleEntry.KorektaPodstawyOpodt = value;
                _saleEntry.KorektaPodstawyOpodtSpecified = value != 0;

                _saleEntry.ItemElementNameSpecified = value != 0;
                _saleEntry.ItemSpecified = value != 0;
        ...
        public decimal K_13
        {
            ...
            set
            {
                _saleEntry.K_13 = value;
                _saleEntry.K_13Specified = value != 0;
            }
        }
        ...
        public decimal K_14
        {
            ...
            set
            {
                _saleEntry.K_14 = value;
                _saleEntry.K_14Specified = value != 0;
            }
        }
