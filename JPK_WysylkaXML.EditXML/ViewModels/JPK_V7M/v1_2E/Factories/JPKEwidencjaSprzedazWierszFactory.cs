...
namespace JPK_WysylkaXML.EditXML.ViewModels.JPK_V7M.v1_2E.Factories
{
    public class JPKEwidencjaSprzedazWierszFactory
    {
        ...
        private int swFieldIndex = 20;
        private int eeFieldIndex = 21;
        ...
        private int mPPField=32;
        private int korektaPodstawyOpodtField=33;

        private int k_10FieldIndex = 34;
        private int k_11FieldIndex = 35;
        private int k_12FieldIndex = 36;
        private int k_13FieldIndex = 37;
        private int k_14FieldIndex = 38;
        private int k_15FieldIndex = 39;
        private int k_16FieldIndex = 40;
        private int k_17FieldIndex = 41;
        private int k_18FieldIndex = 42;
        private int k_19FieldIndex = 43;
        private int k_20FieldIndex = 44;
        private int k_21FieldIndex = 45;
        private int k_22FieldIndex = 46;
        private int k_23FieldIndex = 47;
        private int k_24FieldIndex = 48;
        private int k_25FieldIndex = 49;
        private int k_26FieldIndex = 50;
        private int k_27FieldIndex = 51;
        private int k_28FieldIndex = 52;
        private int k_29FieldIndex = 53;
        private int k_30FieldIndex = 54;
        private int k_31FieldIndex = 55;
        private int k_32FieldIndex = 56;
        private int k_33FieldIndex = 57;
        private int k_34FieldIndex = 58;
        private int k_35FieldIndex = 59;
        private int k_36FieldIndex = 60;
        private int sprzedazVAT_MarzaFieldIndex = 61;
        ...
        public JPKEwidencjaSprzedazWiersz Create(string line)
        {
            ...
            SetSbyteValue(ewidencjaSprzedazWiersz, nameof(ewidencjaSprzedazWiersz.SW), singleValues[swFieldIndex]);
            SetSbyteValue(ewidencjaSprzedazWiersz, nameof(ewidencjaSprzedazWiersz.EE), singleValues[eeFieldIndex]);
            ...
            SetSbyteValue(ewidencjaSprzedazWiersz, nameof(ewidencjaSprzedazWiersz.MPP), singleValues[mPPField]);
