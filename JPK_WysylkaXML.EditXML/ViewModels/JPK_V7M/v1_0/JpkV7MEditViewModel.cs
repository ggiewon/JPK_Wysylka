...
using JPK_WysylkaXML.EditXML.Interfaces.JPK_V7M.v1_0;
using JPK_WysylkaXML.EditXML.Views.JPK_V7M.v1_0;
...
{
    public class JpkV7MEditViewModel : ViewModelBase, IJpkV7MEditViewModel
    {
        ...
        private readonly XmlTypes.Version3_v7m.v1_0.JPK _jpkFile;
        ...
        public JpkV7MEditViewModel(string filePath)
        {
            _filePath = filePath;
            ...
            var serializer = new XmlSerializer(typeof(XmlTypes.Version3_v7m.v1_0.JPK));

            using (var fileStream = new FileStream(filePath, FileMode.Open))
            {
                _jpkFile = (XmlTypes.Version3_v7m.v1_0.JPK) serializer.Deserialize(fileStream);
            }
        ...
        private void SaveCommandExecute(object obj)
        {
            ...
            {
                for (int i = 0; i < _jpkFile.SprzedazWiersz.Length; i++)
                {
            ...
            {
                for (int i = 0; i < _jpkFile.ZakupWiersz.Length; i++)
                {
